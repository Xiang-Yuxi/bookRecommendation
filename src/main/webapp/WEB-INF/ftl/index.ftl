    ...
    <script>
        ...
        $(function () {
            ...
            $(".category").click(function () {
                ...
                $(this).addClass("highlight"); //捕获当前点击的超链接
                var categoryId = $(this).data("category");
                $("#categoryId").val(categoryId);
                loadMore(true); //true:每点击一次相当于进行重新的查询，要从第一页开始
            })
            ...
            $(".order").click(function () {
                ...
                $("#order").val(order);   //点击不同的超链接的时候，为对应隐藏域进行赋值
                loadMore(true);
            })
...
<div class="container">
    <nav class="navbar navbar-light bg-white shadow mr-auto">
        <ul class="nav">
            <li class="nav-item">
                <a href="/">
                    <img src=".\images\a1.png" class="mt-1" style="width: 200px">
                </a>
            </li>
            ...
            <#if loginMember??>
                <h6 class="mt-1">
                <#-- 已登录的显示用户昵称-->
                    <img style="width: 5rem;margin-top: -5px" class="mr-1" src="./images/user_icon.png">${loginMember.nickname}
                </h6>
            <#else>
                <a href="/login.html" class="btn btn-light btn-sm">
                <#-- 未登录的显示用户按钮-->
                    <img style="width: 5rem;margin-top: -5px" class="mr-1" src="./images/user_icon.png">登录
                </a>
            </#if>
